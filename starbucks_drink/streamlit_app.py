...
with title[1]: 
    st.image('starbucks_drink//image///logo.png', width = 700)
...
find_image = {
	'Smoothies - Banana Chocolate Smoothie': 'starbucks_drink//image//sample.png',
	'Coffee - Brewed Coffee': 'starbucks_drink//image//Veranda_Blend_Hot.png',
	'Classic Espresso Drinks - Caffe Americano': 'starbucks_drink//image//coffe//CaffeAmericano.png',
	'Classic Espresso Drinks - Caffe Latte': 'starbucks_drink//image//coffe//CaffeLatte.png',
	'Classic Espresso Drinks - Caffe Mocha (Without Whipped Cream)': 'starbucks_drink//image//coffe//CaffeMocha.png',
	'Classic Espresso Drinks - Cappuccino': 'starbucks_drink//image//coffe//Cappuccino.png',
	'Frappuccino Light Blended Coffee - Caramel': 'starbucks_drink//image//frapp//CaramelFrapp.png',
	'Frappuccino Blended Coffee - Caramel (Without Whipped Cream)': 'starbucks_drink//image//frapp//CaramelFrapp.png',
	'Signature Espresso Drinks - Caramel Apple Spice (Without Whipped Cream)': 'starbucks_drink//image//coffe//CaramelMacchiato.png',
	'Signature Espresso Drinks - Caramel Macchiato': 'starbucks_drink//image//coffe//CaramelMacchiato.png',
	'Frappuccino Blended Coffee - Coffee': 'starbucks_drink//image//frapp//CoffeeFrapp.png',
	'Frappuccino Light Blended Coffee - Coffee': 'starbucks_drink//image//frapp//CoffeeFrapp.png',
	'Classic Espresso Drinks - Espresso': 'starbucks_drink//image//coffe//Espresso_Single.png',
	'Signature Espresso Drinks - Hot Chocolate (Without Whipped Cream)': 'starbucks_drink//image//coffe//SignatureHotChocolat.png',
	'Shaken Iced Beverages - Iced Brewed Coffee (With Classic Syrup)': 'starbucks_drink//image//ColdBrew.png',
	'Shaken Iced Beverages - Iced Brewed Coffee (With Milk & Classic Syrup)': 'starbucks_drink//image//ColdBrew.png',
	'Frappuccino Light Blended Coffee - Java Chip': 'starbucks_drink//image//frapp//JavaChipFrapp.png',
	'Frappuccino Blended Coffee - Java Chip (Without Whipped Cream)': 'starbucks_drink//image//frapp//JavaChipFrapp.png',
	'Frappuccino Light Blended Coffee - Mocha': 'starbucks_drink//image//frapp//MochaFrapp.png',
	'Frappuccino Blended Coffee - Mocha (Without Whipped Cream)': 'starbucks_drink//image//frapp//MochaFrapp.png',
	'Smoothies - Orange Mango Banana Smoothie': 'starbucks_drink//image//sample.png',
	'Shaken Iced Beverages - Shaken Iced Tazo Tea (With Classic Syrup)': 'starbucks_drink//image//IcedChaiTeaLatte.png',
	'Shaken Iced Beverages - Shaken Iced Tazo Tea Lemonade (With Classic Syrup)': 'starbucks_drink//image//IcedChaiTeaLatte.png',
	'Classic Espresso Drinks - Skinny Latte (Any Flavour)': 'starbucks_drink//image//coffe//CaffeLatte.png',
	'Frappuccino Blended Creme - Strawberries & Creme (Without Whipped Cream)': 'starbucks_drink//image//frapp//StrawberryFrapp.png',
	'Smoothies - Strawberry Banana Smoothie': 'starbucks_drink//image//sample.png',
	'Tazo Tea Drinks - Tazo Chai Tea Latte': 'starbucks_drink//image//ChaiBrewedTea.png',
	'Tazo Tea Drinks - Tazo Full-Leaf Red Tea Latte (Vanilla Rooibos)': 'starbucks_drink//image//ChaiBrewedTea.png',
	'Tazo Tea Drinks - Tazo Full-Leaf Tea Latte': 'starbucks_drink//image//ChaiBrewedTea.png',
	'Tazo Tea Drinks - Tazo Green Tea Latte': 'starbucks_drink//image//ChaiBrewedTea.png',
	'Tazo Tea Drinks - Tazo Tea': 'starbucks_drink//image//ChaiBrewedTea.png',
	'Frappuccino Blended Creme - Vanilla Bean (Without Whipped Cream)': 'starbucks_drink//image//frapp//VanillaBeanFrapp.png',
	'Classic Espresso Drinks - Vanilla Latte (Or Other Flavoured Latte)': 'starbucks_drink//image//coffe//VanillaCaffeLatte.png',
	'Signature Espresso Drinks - White Chocolate Mocha (Without Whipped Cream)': 'starbucks_drink//image//coffe//WhiteChocolateMocha.png',
}
